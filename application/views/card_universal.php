    ...
    <body style=" background-image: url('<?php echo base_url().$details->ecard_form_background; ?>');">
                    ...
                    <div class="page-send-greetings float-100">
                        <div class="send-greetings-form">
                            ...
                            <form class="send-message-form" method="POST" action="" id="user_card_mail_form">
                                <select name="from_admin_card"  id="from_admin_card">
									<option value="<?php  echo $details->id; ?>" selected><?php echo $details->ecard_title;?></option>
                                </select>
<!--
                                    <span  id="non_login_user_card" data-cardid="<?php echo $details->id;?>" ><?php echo $details->ecard_title;  ?></span>
								...
								<?php } ?>
                                    ...
                                    <div class="form-type"> 
                                        ...
                                        <select id="card_message_en" class="input" name="card_message_en">
                                            <option value="">-- Please select --</option>
                                            <?php 
                                             $language_eng = explode("-",$details->ecard_eng_greeting);
                                    ...
                                    <div class="form-type">  <label for="card_message_zh">Card message (Chinese)</label>
                                        <select id="card_message_zh" class="input" name="card_message_zh">
                                            <option value="">-- Please select --</option>
                                              <?php 
                                             $language_china = explode("-",$details->ecard_chinese_greeting);
                    ...
                    jQuery(document).ready(function () {
                        jQuery('#mail_card_to_user').on('click', function () {
                            ...
                            if (card_id && from_name && from_title && from_company && to_name && to_email && card_message_en && card_message_zh && lang && message) {
                                jQuery.ajax({
                                    type: "POST",
                                    url: "<?php echo base_url(); ?>" + "index.php/sendcard/ajax_send_mail",
                                    dataType: 'json',
                                    data: {data: data},
                        ...
                        jQuery('.from-admin-card').on('change', function () {
                            ...
                            jQuery.ajax({
                                type: "POST",
                                url: "<?php echo base_url(); ?>" + "index.php/sendcard/admin_card_get",
                                dataType: 'json',
                                data: {id: id},
                                success: function (data) {
                        ...
                        jQuery('#preview').on('click', function () {
                            ...
                            if (card_id && from_name && from_title && from_company && to_name && to_email && card_message_en && card_message_zh && lang && message) {
                                var url = 'http://ecard.ophubsolutions.com/ecard/index.php/sendcard/preview_path?card_id='+card_id+'&company_name='+from_company;
                                window.open(url);
                            } else {
                                return false;
                            }
