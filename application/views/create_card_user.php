   ...
   <div class="row">
	...
	<?php $form_data=array('class'=>'create_card'); echo form_open_multipart( base_url().'index.php/users/create/create_card_save?id='.$_SESSION['user_id'],$form_data);?>			
<!--
...
-->
  ...
  <div class="form-type">Upload Ecard Animation:<input type="file" name="ecard_animation" /><div><?php if(isset($data['ecard_animation']) && !empty($data['ecard_animation'])){echo $data['ecard_animation'];} ?></div></div>  
...
<div><?php if(isset($data['ecard_image'])&& !empty($data['ecard_image'])){echo $data['ecard_image']." please upload file of dimention 1900*900";} ?></div>
  ...
  <div class="form-type">Upload Ecard Music:<input type="file" name="ecard_music" /><div><?php if(isset($data['ecard_music'])&& !empty($data['ecard_music'])){echo $data['ecard_music'];} ?></div></div>  

 <div class="form-type">Insert English Greeting <div class="field_wrapper"><input type="text" name="eng_grt[]" value=""/><a href="javascript:void(0);" class="add_button" title="Add field">ADD</a></div></div>  

  <div class="form-type">Insert Chinese Greeting:<div class="field_wrapper1"><input type="text" name="china_grt[]" /><a href="javascript:void(0);" class="add_ch" title="Add field">ADD</a></div></div>  
